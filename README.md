...
Experience how a simple rollup works by exploring our [`demo-rollup-avail`](./examples/demo-rollup-avail/README.md) tutorial. To run a Sovereign Rollup with Avail DA.
